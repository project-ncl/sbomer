 ...
 */
package org.jboss.sbomer.core.dto.v1beta2;
...
@Schema(name = "V2BaseBeta2TaskRecord")
public record V1BaseBeta2TaskRecord(String id, Instant receivalTime, RequestEventType eventType,
