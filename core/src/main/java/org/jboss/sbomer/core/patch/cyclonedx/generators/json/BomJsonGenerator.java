 ...
 */
package org.jboss.sbomer.core.patch.cyclonedx.generators.json;
...
public class BomJsonGenerator extends AbstractBomGenerator {
    ...
    /**
     * Creates a text representation of a CycloneDX BoM Document. This method calls {@link #toJsonString()} and will
     * return an empty string if {@link #toJsonString()} throws an exception. It's preferred to call
     * {@link #toJsonString()} directly so that exceptions can be caught.
     *
