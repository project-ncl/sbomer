...
public class V1Alpha1ApiProvider extends AbstractApiProvider {

    @Inject
    V1Alpha1Mapper mapper;
    ...
    public SbomGenerationRequestRecord generate(@PathParam("buildId") String buildId, Config config) throws Exception {
        return mapper.toSbomRequestRecord(sbomService.generateFromBuild(buildId, config));
    }
