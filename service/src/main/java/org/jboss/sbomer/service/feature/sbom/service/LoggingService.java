...
import org.jboss.sbomer.service.feature.sbom.runtime.LoggingFilter;
...
/**
 * Exists because directly annotating {@link LoggingFilter} methods with {@link WithSpan} breaks startup due to
 * {@link OpenTelemetry} bean not being available during {@link ExecutionTime#STATIC_INIT}.
 */
@ApplicationScoped
@Slf4j
