...
public class SBOMResourceV1Beta1Test {
    ...
    public void testGetSbomByIdShouldNotFailForMissing() throws IOException {
        given().when()
                ...
                .request("GET", "/api/v1beta1/sboms/5644785")
                .then()
                .statusCode(404)
    ...
    public void testGetSbomById() throws IOException {
        ...
        given().when()
                .contentType(ContentType.JSON)
                .request("GET", "/api/v1beta1/sboms/12345")
                .then()
                .statusCode(200)
    ...
    public void testGetBomById() throws IOException {
        ...
        given().when()
                .contentType(ContentType.JSON)
                .request("GET", "/api/v1beta1/sboms/12345/bom")
                .then()
                .statusCode(200)
                .body(
    ...
    public void testGetSbomByIdShouldHandleIncorrecInput() throws IOException {
        given().when()
                .contentType(ContentType.JSON)
                .request("GET", "/api/v1beta1/sboms/fgETHHG4785")
                .then()
                .statusCode(400)
    ...
    public void shouldStartGenerationForAGivenPncBuild() throws IOException {
        ...
        given().when()
                .contentType(ContentType.JSON)
                .request("POST", "/api/v1beta1/sboms/generate/build/AABBCC")
                .then()
                .statusCode(202)
