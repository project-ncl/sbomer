 ...
 * {@link KubernetesTestServer}.
 * <p>
 * This annotation is only active when used on a test class, but the resource is shared across all test classes.
 * <p>
 * Make sure your tests don't interact with each other.
 */
@WithTestResource(value = SharedKubernetesServerTestResource.class)
@Retention(RetentionPolicy.RUNTIME)
@Target(ElementType.TYPE)
public @interface WithSharedKubernetesTestServer {
