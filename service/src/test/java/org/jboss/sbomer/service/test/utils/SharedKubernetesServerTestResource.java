...
public class SharedKubernetesServerTestResource
        extends AbstractKubernetesTestResource<KubernetesServer, NamespacedKubernetesClient>
        implements QuarkusTestResourceConfigurableLifecycleManager<WithSharedKubernetesTestServer> {
    ...
    @Override
    public void init(WithSharedKubernetesTestServer annotation) {
