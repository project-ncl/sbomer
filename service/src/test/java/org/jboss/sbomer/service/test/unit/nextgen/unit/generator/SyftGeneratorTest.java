...
public class SyftGeneratorTest {
    ...
    void beforeEach() {
        ...
        syftGenerator = new SyftGeneratorAlt(sbomerClientMock, kubernetesClientMock, null, null, null);
    ...
    TaskRun createTaskRun(
        ...
        TaskRun taskRun = new TaskRunBuilder().withNewMetadata()
                .withLabels(Map.of(GenerationTaskRunEventProvider.GENERATION_ID_LABEL, generationRecord.id()))
                .withName(
