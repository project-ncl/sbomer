...
public class BrewRPMControllerTest {
    ...
    void testGetFirstFailedStepExitCode() {
        ...
        assertEquals(
                10,
                BrewRPMController.getFirstFailedStepExitCode(dummyTaskRunWithMultipleSteps(Arrays.asList(0, 0, 10))));
        assertEquals(
                5,
                BrewRPMController.getFirstFailedStepExitCode(dummyTaskRunWithMultipleSteps(Arrays.asList(0, 5, 10))));
