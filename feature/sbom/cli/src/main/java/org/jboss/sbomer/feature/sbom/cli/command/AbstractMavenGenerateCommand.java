...
@Slf4j
public abstract class AbstractMavenGenerateCommand implements Callable<Integer> {
    @Mixin
    ...
    public Integer call() throws Exception {
        ...
        // MDCUtils.addProcessContext(parent.getBuildId());
        MDCUtils.addBuildContext(parent.getBuildId()); // TODO: which one is correct?
