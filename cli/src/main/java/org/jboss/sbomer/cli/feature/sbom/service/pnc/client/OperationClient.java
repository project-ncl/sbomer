...
import org.jboss.sbomer.cli.feature.sbom.service.pnc.endpoint.OperationEndpoint;
...
public class OperationClient extends ClientBase<OperationEndpoint> {
    ...
    public DeliverableAnalyzerOperation getSpecificDeliverableAnalyzer(String id) throws RemoteResourceException {
        try {
            return getEndpoint().getSpecificDeliverableAnalyzer(id);
