...
You need to clone the link:https://gitlab.cee.redhat.com/appsvcs-platform/security/sbomer-helm[sbomer-help] repository
to continue.
...
[source,console]
----
$ helm sbomer-local upgrade --install  --values env/app/prod.yaml sbomer .
