...
Request manifest generation for following zips, storing the results under PNC miletone ID 0:
...
Please note that you must provide a valid PNC miletone ID or analysis will fail.
