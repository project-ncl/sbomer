...
[NOTE]
====
Timestamp fields (e.g., `created`, `updated`, `finished`) support multiple formats. When a timezone is not specified, UTC is assumed.

Supported formats include:
- ISO 8601 (e.g., `"2023-01-01T12:00:00Z"`)
- `yyyy-MM-dd` (e.g., `"2023-10-25"`)
- `yyyy-MM-dd HH:mm` (e.g., `"2023-10-25 14:30"`)
- `yyyy-MM-dd HH:mm:ss` (e.g., `"2023-10-25 14:30:15"`)
====
